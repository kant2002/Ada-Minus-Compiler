...

   ...
   begin
	...
	if file. mode = out_file
	then
		if file. curr_line > to
		then
			new_page (file);
		end if;	
		file. curr_max_lines := to;
	end if;
   end;

...

   ...
   begin
	...
	return count (file. curr_max_lines);
   end;

   ...
   begin
	...
	for i in 1 .. spacing loop
	   file. curr_pnt := 1;
           ...
           if file. curr_line >= file. curr_max_lines
           then
               new_page;
           else
...

   ...
   begin
	...
	then
        ...
        file. curr_pnt := 1;
        file. curr_line := 1;
        file. curr_page := file. curr_page + 1;

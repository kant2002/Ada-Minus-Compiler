...
#define	PREP		"/lib/cpp"
#define	FRONT		HOMEFOLDER "/src/front/ada_front"
#define	BACK		HOMEFOLDER "/src/cg/ada_cg"
#define	PC1		"/bin/cp"
#define	OPT		"/bin/cp"
#define	ASS		"/bin/as"
#define LOADER		"/bin/ld"
#define DASLOAD		HOMEFOLDER "/lib/dasload"
#define	SSTARTUP	HOMEFOLDER "/lib/dasrt0.s"
#define	TASKSTARTUP	HOMEFOLDER "/lib/dastaskrt0.s"
#define	STARTUP		HOMEFOLDER "/lib/dasrt0.o"
#define	DASEXIT		HOMEFOLDER "/lib/dasexit.o"
#define	DASLIB		HOMEFOLDER "/lib/daslib.a"
#define	LIBM		"-lm"
#define LIBC		"-lc"
#define U_STANDARD	"std_ps"
#define	T_STANDARD	HOMEFOLDER "/lib/std_ps.t"
#define	O_STANDARD	HOMEFOLDER "/lib/std_ps.o"
#define	B_STANDARD	HOMEFOLDER "/lib/std_ps.o"
#define AR		"/usr/bin/ar"
#define	CONVERT		HOMEFOLDER "/lib/convert"
